...
function createConfig() {
	...
	if (plugins_list.indexOf('Magnetic CR') != -1)xml += '<plugin name="com.wodify.cordova.plugin.unimag-swiper" spec="https://github.com/tuanway/cordova-plugin-unimag-swiper.git" />\n'
	if (plugins_list.indexOf('IDTech CR') != -1)xml += '<plugin name="com.alignace.cordova.plugin.card.reader" spec="https://github.com/tuanway/card-reader-phonegap.git" />\n'
